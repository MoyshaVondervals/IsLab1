                    ...
                    <Row gutter={[16, 16]}>
                        ...
                        <Col xs={24} lg={12}>
                            <Card size="small" title="Основная информация" style={{height: '100%'}}>
                                <Table dataSource={mainData} columns={tableColumns} pagination={false}
                        ...
                        <Col xs={24} lg={12}>
                            <Card size="small" title="Координаты" style={{height: '100%'}}>
                                {coordinatesData.length > 0 ? (
                                    <Table dataSource={coordinatesData} columns={tableColumns} pagination={false}
                                           showHeader={false} size="small"/>
                                ) : (
                        ...
                        <Col xs={24} lg={12}>
                            <Card size="small" title="Пещера" style={{height: '100%'}}>
                                {caveData.length > 0 ? (
                                    <Table dataSource={caveData} columns={tableColumns} pagination={false}
                                           showHeader={false} size="small"/>
                                ) : (
                                    <Text type="secondary">Нет данных</Text>
                                )}
                        ...
                        <Col xs={24} lg={12}>
                            <Card size="small" title="Голова" style={{height: '100%'}}>
                                {headData.length > 0 ? (
                                    <Table dataSource={headData} columns={tableColumns} pagination={false}
                                           showHeader={false} size="small"/>
                                ) : (
                                    <Text type="secondary">Нет данных</Text>
                                )}
                        ...
                        <Col xs={24} lg={12}>
                            <Card size="small" title="Убийца" style={{height: '100%'}}>
                                {killerData.length > 0 ? (
                                    <Table dataSource={killerData} columns={tableColumns} pagination={false}
                                           showHeader={false} size="small"/>
                                ) : (
                                    <Text type="secondary">Нет данных</Text>
                                )}
                ...
                {notices.length > 0 && (
                    <Card size="small" title={`Уведомления (${notices.length})`}>
                        <Space direction="vertical" style={{width: '100%'}}>
                            {notices.map((n) => (
                                <Alert key={n.id} type={n.type} message={n.content} showIcon closable
